...
/// Date: 09/07/2015 03:34:33
/// Goal: Create User Service Class for DM_HOC_PHAN_MON_HOC
///************************************************
/// <summary>
/// Create User Service Class for DM_HOC_PHAN_MON_HOC
/// </summary>
...
public class US_DM_HOC_PHAN_MON_HOC : US_Object
{
	private const string c_TableName = "DM_HOC_PHAN_MON_HOC";
...
#region "Init Functions"
	public US_DM_HOC_PHAN_MON_HOC() 
	{
		pm_objDS = new DS_DM_HOC_PHAN_MON_HOC();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_DM_HOC_PHAN_MON_HOC(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_DM_HOC_PHAN_MON_HOC(decimal i_dbID) 
	{
		pm_objDS = new DS_DM_HOC_PHAN_MON_HOC();
		pm_strTableName = c_TableName;
    ...
    {
        CStoredProc v_cstore = new CStoredProc("get_dm_hoc_phan_mon_hoc");
