///************************************************
/// Generated by: NGOC
/// Date: 13/07/2015 08:58:59
/// Goal: Create Form for V_HOC_PHAN_MON_HOC
///************************************************
...
namespace BKI_QLTTQuocAnh
{
	...
	public class f110_danh_muc_hoc_phan_mon_hoc : System.Windows.Forms.Form
	{
		...
		public f110_danh_muc_hoc_phan_mon_hoc()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            // 
            // f110_danh_muc_hoc_phan_mon_hoc
            // 
...
,MA_MON_HOC = 3
		...
		DS_V_HOC_PHAN_MON_HOC m_ds = new DS_V_HOC_PHAN_MON_HOC();
		US_V_HOC_PHAN_MON_HOC m_us = new US_V_HOC_PHAN_MON_HOC();
		#endregion
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_HOC_PHAN_MON_HOC.MA_HOC_PHAN, e_col_Number.MA_HOC_PHAN);
			v_htb.Add(V_HOC_PHAN_MON_HOC.TEN_MON_HOC, e_col_Number.TEN_MON_HOC);
			v_htb.Add(V_HOC_PHAN_MON_HOC.TEN_HOC_PHAN, e_col_Number.TEN_HOC_PHAN);
			v_htb.Add(V_HOC_PHAN_MON_HOC.MA_MON_HOC, e_col_Number.MA_MON_HOC);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_ds.V_HOC_PHAN_MON_HOC.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){						
			m_ds = new DS_V_HOC_PHAN_MON_HOC();			
			m_us.FillDataset(m_ds);
			m_fg.Redraw = false;
			CGridUtils.Dataset2C1Grid(m_ds, m_fg, m_obj_trans);
			m_fg.Redraw = true;
		}
		private void grid2us_object(US_V_HOC_PHAN_MON_HOC i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_HOC_PHAN_MON_HOC i_us
			, int i_grid_row) {
		...
		private void update_v_hoc_phan_mon_hoc(){			
		...
		private void delete_v_hoc_phan_mon_hoc(){
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
		...
		private void view_v_hoc_phan_mon_hoc(){			
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			grid2us_object(m_us, m_fg.Row);
            //f110_danh_muc_hoc_phan_mon_hoc_de v_fDE = new f110_danh_muc_hoc_phan_mon_hoc_de();
...
//
		...
		//
		//
		private void f110_danh_muc_hoc_phan_mon_hoc_Load(object sender, System.EventArgs e) {
			try{
