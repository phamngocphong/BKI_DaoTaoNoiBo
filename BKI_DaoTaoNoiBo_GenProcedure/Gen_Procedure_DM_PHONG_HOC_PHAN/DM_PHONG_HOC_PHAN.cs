///////////////////////////////////////////////////////////////////////////
// Description: Data Access class for the table 'DM_PHONG_HOC_PHAN'
// Generated by LLBLGen v1.21.2003.712 Final on: 09 Tháng Bảy 2015, 3:01:16 CH
...
{
	/// <summary>
	/// Purpose: Data Access class for the table 'DM_PHONG_HOC_PHAN'.
	/// </summary>
	public class DM_PHONG_HOC_PHAN : DBInteractionBase
	{
		#region Class Member Declarations
			private SqlDecimal		_iD_HOC_PHAN, _iD_HOC_PHANOld, _iD_PHONG, _iD_PHONGOld, _iD;
		#endregion
		...
		public override bool Insert()
		{
			...
			cmdToExecute.CommandText = "dbo.[pr_DM_PHONG_HOC_PHAN_Insert]";
			...
			catch(Exception ex)
			{
				...
				throw new Exception("DM_PHONG_HOC_PHAN::Insert::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[pr_DM_PHONG_HOC_PHAN_Update]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("DM_PHONG_HOC_PHAN::Update::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[pr_DM_PHONG_HOC_PHAN_UpdateAllWID_PHONGLogic]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("DM_PHONG_HOC_PHAN::UpdateAllWID_PHONGLogic::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[pr_DM_PHONG_HOC_PHAN_UpdateAllWID_HOC_PHANLogic]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("DM_PHONG_HOC_PHAN::UpdateAllWID_HOC_PHANLogic::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[pr_DM_PHONG_HOC_PHAN_Delete]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("DM_PHONG_HOC_PHAN::Delete::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[pr_DM_PHONG_HOC_PHAN_DeleteAllWID_PHONGLogic]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("DM_PHONG_HOC_PHAN::DeleteAllWID_PHONGLogic::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[pr_DM_PHONG_HOC_PHAN_DeleteAllWID_HOC_PHANLogic]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("DM_PHONG_HOC_PHAN::DeleteAllWID_HOC_PHANLogic::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[pr_DM_PHONG_HOC_PHAN_SelectOne]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("DM_PHONG_HOC_PHAN");
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("DM_PHONG_HOC_PHAN::SelectOne::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[pr_DM_PHONG_HOC_PHAN_SelectAll]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("DM_PHONG_HOC_PHAN");
			SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("DM_PHONG_HOC_PHAN::SelectAll::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[pr_DM_PHONG_HOC_PHAN_SelectAllWID_PHONGLogic]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("DM_PHONG_HOC_PHAN");
			SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("DM_PHONG_HOC_PHAN::SelectAllWID_PHONGLogic::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[pr_DM_PHONG_HOC_PHAN_SelectAllWID_HOC_PHANLogic]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("DM_PHONG_HOC_PHAN");
			SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("DM_PHONG_HOC_PHAN::SelectAllWID_HOC_PHANLogic::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
